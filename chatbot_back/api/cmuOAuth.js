...
router.post("/", async (req, res) => {
  try {
    ...
    return res
      ...
      .send(
          {
            cmuAccount: 'khomsan_su@cmu.ac.th',
            firstName: 'khomsan',
            lastName: 'Suangkaew',
            studentId: '630610720',
    ...
    const itAccountType_id = response2.itaccounttype_id;
    ...
    if (!err.response) {
      return res.send({
        ok: false,
        message: "Cannot connect to API Server. Please try again later." + err,
      });
