  ...
  <div className="gpt3__whatgpt3 section__margin" id="wgpt3">
    ...
    <div className="gpt3__whatgpt3-container">
      ...
      <Feature
        ...
        text="พี่เตี้ย สุนัขพันธุ์ทางตัวหนึ่งใน มช. เป็นที่รู้จักจากประเพณีรับน้องขึ้นดอยอันเลื่องชื่อ ในทุกๆ ปีเจ้าหมาแสนรู้ตัวนี้จะร่วมวิ่งขึ้นดอยร่วมกับนักศึกษา เสียชีวิตเมื่อปี พ.ศ."
        className="glowing-border"
      />
    </div>
  </div>
